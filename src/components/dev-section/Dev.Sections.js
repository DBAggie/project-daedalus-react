        ...
        <div className="dev-body">
            <section className="dev-content">
                <div className='divider'>
                    ...
                    <p className='p-p'>The answer to that is pretty simple. I used HTML and CSS to design the webpage you are viewing. There was
                    ...
                    <ul>
                        <li className='li-li'>Create at least 3 webpages using only HTML & CSS</li>
                        <li className='li-li'>Utilize a unique feature of both languages</li>
                        <li className='li-li'>Create a responsive website</li>
                    </ul>
                    <p className='p-p'>So...That is not a lot of requirements right. I did put some restrictions on myself. See, with this
                        ...
                        restrictions:</p>
                    <ul>
                        <li className='li-li'>The webpage can only be created and styled using HTML & CSS that I wrote</li>
                        <li className='li-li'>Javascript can be used only for the use of interacting with the DOM for the applications part of
                            this project</li>
                        <li className='li-li'>The site must be completely self-contained and run offline
                            <ul>
                                <li className='li-li'>An exclusion is made for Fonts...Get off my back</li>
                            </ul>
                        </li>
                        <li className='li-li'>When asking Dr. Google a question I am only allowed to read documentation
                            <ul>
                                <li className='li-li'>The only exclusion I gave myself was when I would get truly stuck and allowed myself to read
                                    Stackoverflow</li>
                                <li className='li-li'>I did not allow myself to directly rip code. I required myself to read anything I didn't
                                    understand and rewrite it from scratch</li>
                            </ul>
                        </li>
                    </ul>
                    <p className='p-p'>That's the project. It's nothing fancy. I feel like a lot the projects I have going are too big scale. I
                ...
                <div className='divider'>
                    <h2>Home Page:</h2>
                    <p className='p-p'>This took me a long time to design. I didn’t draft the content I wanted in any particular section of the
                        Home page so I
                    ...
                    <ul>
                        <li className='li-li'>I wanted to have a header that filled the width of the screen and followed the page as it scrolled
                            <ul>
                                <li className='li-li'>Within this I wanted to have a logo and navigation options
                                    <ul>
                                        <li className='li-li'>This expanded to adding the social logos in the header as well</li>
                                        <li className='li-li'>This was because I didn’t know how to space things the way I wanted with no content
                                            in a spot</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li className='li-li'>I wanted to have 3 unique sections
                            <ul>
                                <li className='li-li'>The first section would be a background image that filled the initial loading screen</li>
                                <li className='li-li'>The second section would be a quick textual description on the project</li>
                                <li className='li-li'>The third section would be a card system to link to the various apps and version of the site
                                    I have developed</li>
                            </ul>
                        </li>
                        <li className='li-li'>The last section was the footer
                            <ul>
                                <li className='li-li'>Honestly, not much to talk about here</li>
                                <li className='li-li'>Ripped code from the header and adjusted it for the footer</li>
                            </ul>
                        </li>
                    </ul>
                    <p className='p-p'>When designing this page I started styling it entirely with Flexbox. I played around with different
                        design systems on
                        ...
                        the best option
                        here.</p>
                    <p className='p-p'>The cover image was a pain. I forgot a bunch of the CSS tools I needed to accomplish the same task and
                        ended
                        up doing this
                    ...
                    <p className='p-p'>The explanation section was easy. Nothing to talk about here. Because I used flexbox I had to do a little
                        more work to
                    ...
                    <p className='p-p'>I created the app and site cards from scratch and learned a lot of about positioning and how best to lay
                        things out
                    ...
                    <h2>About Me</h2>
                    <p className='p-p'>This page was pretty easy to make. I wanted this to be a single page with a very simple layout. Two boxes
                        side by side
                    ...
                    <p className='p-p'>One thing I learned on this page was that I liked the easier to position grid system for this purpose. It
                        was very quick
                ...
                <div className='divider'>
                    <h2>Dev Info</h2>
                    <p className='p-p'>This page is my baby. I reworked it from scratch compared to the first page. I found out that I have been
                    ...
                    <p className='p-p'>After all of the work I have put in to this project we are at the end of phase 1. This was enlightening
                    ...
                    <p className='p-p'>So what is there left to do on this website. Well a lot. This is just Phase 1 of a 3 Phase project. I
                    ...
                    <ul>
                        <li className='li-li'>Create a true Global Styles sheet for common items across pages</li>
                        <li className='li-li'>Refactor the Homepage to correct the Overlay and page content issues</li>
                        <li className='li-li'>Refactor the responsiveness of the website on non-standard sizings
                            <ul>
                                <li className='li-li'>This is primarily looking at Mobile sized web browsers</li>
                            </ul>
                        </li>
                        <li className='li-li'>Add global styling for the below tags
                            <ul>
                                <li className='li-li'>Paragraphs
                                </li>
                                <li className='li-li'>Lists
                                </li>
                                <li className='li-li'>Headings -
                                    <ul>
                                        <li className='li-li'>Heading 1
                                        </li>
                                        <li className='li-li'>Heading 2
                                        </li>
                                        <li className='li-li'>Heading 3
                                        </li>
                                    </ul>
                                </li>
                            </ul>
